...
//
//     final tripNewModels = tripNewModelsFromJson(jsonString);

import 'dart:convert';

TripNewModels tripNewModelsFromJson(String str) => TripNewModels.fromJson(json.decode(str));

String tripNewModelsToJson(TripNewModels data) => json.encode(data.toJson());
...
class TripNewModels {
  ...
  factory TripNewModels.fromJson(Map<String, dynamic> json) => TripNewModels(
    status: json["status"],
