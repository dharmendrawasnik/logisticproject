...
//
//     final readinessAddValueModels = readinessAddValueModelsFromJson(jsonString);

import 'dart:convert';

ReadinessAddValueModels readinessAddValueModelsFromJson(String str) => ReadinessAddValueModels.fromJson(json.decode(str));

String readinessAddValueModelsToJson(ReadinessAddValueModels data) => json.encode(data.toJson());

class ReadinessAddValueModels {
  ReadinessAddValueModels({
    this.status,
    this.message,
    this.result,
  });
  ...
  factory ReadinessAddValueModels.fromJson(Map<String, dynamic> json) => ReadinessAddValueModels(
    status: json["status"],
...
class ResultElement {
  ...
  dynamic truckFullFueiledUpForTrip;
  dynamic gpsTruckFunctioning;
  dynamic gpsTrailerFunctioning;
  String? padlockForThisRun;
  dynamic driverFitForDuty;
