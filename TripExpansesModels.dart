...
//
//     final tripExpansesModels = tripExpansesModelsFromJson(jsonString);

import 'dart:convert';

TripExpansesModels tripExpansesModelsFromJson(String str) => TripExpansesModels.fromJson(json.decode(str));

String tripExpansesModelsToJson(TripExpansesModels data) => json.encode(data.toJson());

class TripExpansesModels {
  int? status;
  String? message;
  Result? result;
  ...
  factory TripExpansesModels.fromJson(Map<String, dynamic> json) => TripExpansesModels(
    status: json["status"],
