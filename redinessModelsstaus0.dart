...
ReadinessDetailsModels1 readinessDetailsModelsFromJson(String str) => ReadinessDetailsModels1.fromJson(json.decode(str));

String readinessDetailsModelsToJson(ReadinessDetailsModels1 data) => json.encode(data.toJson());

class ReadinessDetailsModels1 {
  ReadinessDetailsModels1({
    this.status,
    this.message,
    this.result,
  });
  ...
  factory ReadinessDetailsModels1.fromJson(Map<String, dynamic> json) => ReadinessDetailsModels1(
    status: json["status"],
